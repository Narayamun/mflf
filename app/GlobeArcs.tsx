...
export default function GlobeArcs({ arcs, countries, highlight, onSelect }: Props) {
  ...
  // ResizeObserver catches container reflow that a window-resize listener would miss.
  useEffect(() => {
  ...
  return (
    <div ref={wrapRef} style={{ background: "#06070d", borderRadius: 12, overflow: "hidden", marginBottom: 16, height: size.height, minHeight: 300 }}>
      <Boundary>
        <GlobeGl
          width={size.width}
          height={size.height}
